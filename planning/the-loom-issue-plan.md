...
**Distribution:** 14 Sonnet · 11 Opus. Of the 11 Opus, only ~6 are actual coding — the rest are decision or epic-decomposition issues.
...
| L-121 | 306 | Save & resume                                              | **Sonnet** | Standard save-list CRUD against `loom_saves`                                    |
| L-130 | 307 | Jest integration tests for `loomPlayTurn`                  | **Sonnet** | Emulator + mocked-AI harness with fixture factories                             |
...
| L-300 | 314 | [Epic] Cartographer: Azgaar map → draft world | **Opus**   | Decompose; design the Azgaar → canon mapping and the Firestore canon seam (L-103); see `the-cartographer-design.md` |
...
- **Sonnet 4.6 (14):** #293, #294, #295, #298, #300, #301, #302, #303, #304, #305, #306, #307, #313, #318
- **Opus 4.8 (11):** #296, #297, #299, #308, #309, #310, #311, #312, #314, #316, #317
