...
- DC GUIDE (Difficulty Class): Most player actions should be DC 5-10. Reserve high DCs for genuinely difficult or absurd actions. Default to LOW DCs — err on the side of letting players succeed.
  DC 3-5 (Trivial): Looking around, talking to friendly NPCs, docking at a station, checking cargo, reading a log, routine ship operations, walking through a safe area, buying common goods at a shop.
  DC 6-8 (Easy): Asking an NPC for directions, basic repairs with an engineer present, navigating a known safe route, trading at fair market price, investigating an obvious clue, scanning a nearby object with working sensors.
  DC 9-11 (Moderate): Persuading a neutral NPC, navigating through a debris field, bartering for a better price, picking up a distress signal, performing non-trivial repairs, sneaking past inattentive guards, investigating a hidden compartment.
